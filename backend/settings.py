...
EMAIL_HOST_USER = 'ychafiqui2@gmail.com' # in order to aptusadmin email verification to work
EMAIL_HOST_PASSWORD = 'mcbqxxjeodsilnfo' # in order to aptusadmin email verification to work
